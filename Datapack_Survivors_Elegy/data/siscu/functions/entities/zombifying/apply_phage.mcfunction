...
execute at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["zombie_cloud"], Effects:[{Id:27,Amplifier:19,Duration:10}], Duration:2, ReapplicationDelay:0, WaitTime:-1, Age:-1, Particle:"minecraft:dust 0 0 0 0"}
