...
data merge entity @e[tag=boat_flag,tag=!resolved,type=minecraft:item_display,limit=1] {Rotation:[0.0f,0.0f],transformation:{right_rotation:[0.0f,0.6f,0.0f,0.8f],translation:[0.0f,0.75f,0.0f]}}
