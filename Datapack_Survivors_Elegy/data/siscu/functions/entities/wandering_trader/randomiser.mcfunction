...
#execute if predicate siscu:utils/50_percent run tag @s add siscu.dungeons_trader
#execute if entity @s[tag=siscu.dungeons_trader] run function siscu:entities/wandering_trader/dungeon_trader
