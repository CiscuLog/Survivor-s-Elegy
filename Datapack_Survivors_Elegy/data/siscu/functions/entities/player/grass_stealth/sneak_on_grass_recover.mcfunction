execute if score @s siscu.grass_stealth matches 20..40 at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["stealth_cloud"], Particle: "minecraft:dust 0 0 0 0", Effects:[{Id:14,Amplifier:1,Duration:3,ShowIcon:0b,ShowParticles:0b}], Duration:2, ReapplicationDelay:0, WaitTime:-1, Age:-1, Radius:0.2}
...
execute unless predicate siscu:entities/is_sneaking at @s run particle block minecraft:tall_grass ~ ~1 ~ 0.2 0.5 0.2 0 10
