...
execute if score @s siscu.dimension matches 3 run tellraw @s [{"text":"Last Death: ","color":"red","bold":"true"},{"entity":"@s","nbt":"LastDeathLocation.pos[0]","color":"white"},{"text":" "},{"entity":"@s","nbt":"LastDeathLocation.pos[1]","color":"white"},{"text":" "},{"entity":"@s","nbt":"LastDeathLocation.pos[2]","color":"white"},{"entity":"@s","nbt":"LastDeathLocation.dimension","color":"gray"},{"text":"]","color":"gray"}]
