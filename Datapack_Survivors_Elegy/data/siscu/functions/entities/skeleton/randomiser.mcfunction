...
execute unless predicate siscu:entities/is_riding_skeleton_horse run loot replace entity @s[tag=!villager,tag=!piglin] weapon loot siscu:groups/skeleton_weapons
