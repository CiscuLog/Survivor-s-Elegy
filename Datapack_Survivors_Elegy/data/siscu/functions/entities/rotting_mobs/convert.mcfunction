...
## Entity Behav ##
execute if score @s[type=#siscu:rotting_mobs,predicate=siscu:utils/is_not_baby,tag=!stray_zombie] siscu.rotting_mob matches 100.. at @s run function siscu:entities/rotting_mobs/summon_skeleton
