...
execute if score @s siscu.warped_food matches 26..30 run effect give @s minecraft:nausea 8 1 true
...
execute if score @s siscu.warped_food matches 20.. run effect give @s minecraft:weakness 16 0 false
