#create scoreboards
execute unless data storage siscu:world {PackVersion:"alpha v0.7.1"} run function siscu:technical/load_first_time
...
execute if score do_daylight_cycle siscu.day matches 1 run function siscu:world/day_features/advance