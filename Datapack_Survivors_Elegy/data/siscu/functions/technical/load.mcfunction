#create scoreboards
execute unless data storage siscu:world {PackVersion:"alpha v0.7.2"} run function siscu:technical/load_first_time
...
# Remove advancements
advancement revoke @a only siscu:entities/players_sleep