...
execute if score siscu.damage_amount siscu.volatile matches ..-1 run scoreboard players operation siscu.damage siscu.volatile += volatile.damage_amount siscu.volatile
