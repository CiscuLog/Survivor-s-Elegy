...
execute store result score siscu.previous_damage siscu.test run data get entity @s Inventory[{Slot:101b}].tag.SE_data.PreviousDamage
execute store result score siscu.damage_amount siscu.test run data get entity @s Inventory[{Slot:101b}].tag.Damage

execute store result score siscu.real_damage siscu.test run data get entity @s Inventory[{Slot:101b}].tag.SE_data.RealDurability
execute store result score siscu.damage siscu.test run data get entity @s Inventory[{Slot:101b}].tag.SE_data.Damage
execute store result score siscu.durability siscu.test run data get entity @s Inventory[{Slot:101b}].tag.SE_data.Durability
