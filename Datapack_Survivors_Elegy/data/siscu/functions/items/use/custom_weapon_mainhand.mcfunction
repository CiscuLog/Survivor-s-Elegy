...
execute store result score siscu.previous_damage siscu.volatile run data get entity @s SelectedItem.tag.SE_data.PreviousDamage
execute store result score siscu.damage_amount siscu.volatile run data get entity @s SelectedItem.tag.Damage

execute store result score siscu.durability siscu.volatile run data get entity @s SelectedItem.tag.SE_data.Durability
execute store result score siscu.damage siscu.volatile run data get entity @s SelectedItem.tag.SE_data.Damage
execute store result score siscu.real_damage siscu.volatile run data get entity @s SelectedItem.tag.SE_data.RealDurability
...
execute unless score siscu.damage siscu.volatile > siscu.durability siscu.volatile run item modify entity @s weapon.mainhand siscu:durability/rewrite_data
