...
execute store result score siscu.previous_damage siscu.test run data get entity @s Inventory[{Slot:100b}].tag.SE_data.PreviousDamage
execute store result score siscu.damage_amount siscu.test run data get entity @s Inventory[{Slot:100b}].tag.Damage

execute store result score siscu.real_damage siscu.test run data get entity @s Inventory[{Slot:100b}].tag.SE_data.RealDurability
execute store result score siscu.damage siscu.test run data get entity @s Inventory[{Slot:100b}].tag.SE_data.Damage
execute store result score siscu.durability siscu.test run data get entity @s Inventory[{Slot:100b}].tag.SE_data.Durability
...
execute unless score siscu.damage siscu.test > siscu.durability siscu.test run item modify entity @s armor.feet siscu:durability/rewrite_data
