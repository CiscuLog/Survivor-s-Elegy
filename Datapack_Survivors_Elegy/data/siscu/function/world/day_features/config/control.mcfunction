...
tellraw @s [{"translate":"\n\n\n\n%===Daytime Length Configuration Panel===[","bold":true,"color":"aqua"},{"text":"Return","font":"siscu_se:superscript","bold":false,"color":"red","clickEvent":{"action":"run_command","value":"/function siscu:config"},"hoverEvent":{"action":"show_text","contents":{"text":"Return to menu"}}},{"text":"]","color":"aqua"}]
...
execute if score do_daylight_cycle siscu.day matches 1 run tellraw @s [{"text":"- Enable / Freeze daylight cycle: ","color":"gold","bold":false},{"text":"[ Enabled ]","color":"green","bold":true,"clickEvent":{"action":"run_command","value":"/function siscu:world/day_features/config/disable_cycle"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to change"}}}]

execute unless score do_daylight_cycle siscu.day matches 1 run tellraw @s [{"text":"- Enable / Freeze daylight cycle: ","color":"gold","bold":false},{"text":"[ Frozen ]","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/function siscu:world/day_features/config/enable_cycle"},"hoverEvent":{"action":"show_text","contents":{"text":"Click to change"}}}]
