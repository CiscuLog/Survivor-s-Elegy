...
execute if score day_residue siscu.day matches 1 unless score day_decade siscu.day matches 10..19 run title @a title [{"translate":"title.siscu.new_day"},{"score":{"name":"Day","objective":"siscu.day"}},{"translate":"title.siscu.cardinal_1"},{"translate":"title.siscu.new_day2"}]
