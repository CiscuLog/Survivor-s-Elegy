...
execute run function siscu:blocks/broth_cauldron/update/textures

# return if the water level hasn't changed
execute if score broth_level siscu.broth_data = x siscu.broth_data run return 1
...
execute if score x siscu.broth_data < broth_level siscu.broth_data run function siscu:blocks/broth_cauldron/update/decrease_broth_properties
