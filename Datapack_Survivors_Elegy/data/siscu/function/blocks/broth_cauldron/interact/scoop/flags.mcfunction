...
# cures phage
execute if data storage siscu:volatile BrothServingData.effects[{id:"minecraft:weakness"}] if data storage siscu:volatile BrothServingData.effects[{id:"minecraft:absorption"}] run data modify storage siscu:volatile BrothServingData.flags append value {cures_siscu:true}
