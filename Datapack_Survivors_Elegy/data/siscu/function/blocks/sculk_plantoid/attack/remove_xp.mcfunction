...
execute if entity @n[tag=siscu.plantoid_beating,predicate=!siscu:entities/is_sneaking] run function siscu:blocks/sculk_plantoid/attack/remove_xp_standing
execute if entity @n[tag=siscu.plantoid_beating,predicate=siscu:entities/is_sneaking] run function siscu:blocks/sculk_plantoid/attack/remove_xp_crouching
...
execute as @p[tag=siscu.plantoid_beating] run function siscu:blocks/sculk_plantoid/interact/add_player_xp_macro with storage siscu:volatile

# visual effects
execute as @n[tag=siscu.sculk_plantoid,type=item_display] run function siscu:blocks/sculk_plantoid/update/texture
