...
execute as @p[tag=siscu.plantoid_interacting] run execute store result score xp_player siscu.volatile run experience query @s levels
...
function siscu:blocks/sculk_plantoid/interact/add_xp_standing
