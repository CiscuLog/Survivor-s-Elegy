...
# give bottle
item modify entity @n[type=player,tag=siscu.plantoid_interacting] weapon.mainhand siscu:decrease_1
execute if items entity @s weapon.mainhand air run return run item replace entity @s weapon with experience_bottle

give @n[type=player,tag=siscu.plantoid_interacting] experience_bottle
advancement grant @n[type=player,tag=siscu.plantoid_interacting] only siscu:minecraft/husbandry/xp_bottle_from_plantoid
