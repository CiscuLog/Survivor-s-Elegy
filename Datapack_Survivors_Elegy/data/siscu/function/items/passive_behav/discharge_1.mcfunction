...
execute if score charge siscu.volatile matches 1.. if score N siscu.volatile matches 0 run function siscu:items/passive_behav/discharge_copper_item
...
execute as @e[tag=siscu.discharge_path] at @s facing entity @e[type=player,limit=1] feet rotated ~40 ~ run function siscu:items/passive_behav/discharge_effect
...
execute on attacker if predicate siscu:entities/is_wearing_netherite run damage @s[type=!#siscu:discharge_immune] 6 siscu:copper_discharge by @e[tag=discharging,limit=1]
