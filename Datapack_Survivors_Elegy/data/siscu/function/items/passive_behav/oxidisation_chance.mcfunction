...
execute if predicate siscu:entities/is_holding_copper_shield if predicate siscu:utils/50_percent if score shield_ox siscu.volatile = min_ox siscu.volatile run function siscu:items/passive_behav/oxidise_copper_shield
