...
# get base name depending on the SE_data.id

$execute if items entity @s $(Slot) copper_axe run return run data merge storage siscu:volatile {String2:"copper_axe"}
$execute if items entity @s $(Slot) copper_pickaxe run return run data merge storage siscu:volatile {String2:"copper_pickaxe"}
...
$execute if items entity @s $(Slot) copper_leggings run return run data merge storage siscu:volatile {String2:"copper_leggings"}
$execute if items entity @s $(Slot) copper_boots run return run data merge storage siscu:volatile {String2:"copper_boots"}