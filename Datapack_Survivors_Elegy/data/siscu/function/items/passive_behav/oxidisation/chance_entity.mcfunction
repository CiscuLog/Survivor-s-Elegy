...
execute if items entity @s weapon.mainhand #siscu:oxidisable_items store result score tool_ox siscu.volatile run data get entity @s equipment.mainhand.components."minecraft:custom_data".SE_data.Oxidation
