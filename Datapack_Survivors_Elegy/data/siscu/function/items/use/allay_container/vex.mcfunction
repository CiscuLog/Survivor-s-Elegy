...
playsound minecraft:entity.vex.charge hostile
execute at @s positioned ~ ~1.4 ~ positioned ^ ^ ^1 run summon vex
...
execute if items entity @s weapon.mainhand *[custom_data~{"SE_data":{"ContainsVex": true}}] run scoreboard players set x siscu.volatile 1
