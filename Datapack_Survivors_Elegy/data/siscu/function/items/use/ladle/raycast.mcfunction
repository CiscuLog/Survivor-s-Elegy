...
execute if block ~ ~ ~ #siscu:broth_cauldrons_allow_ladle align xyz positioned ~0.5 ~0.2 ~0.5 unless entity @e[tag=siscu.broth_cauldron,distance=..0.5] positioned ~ ~ ~ run return run function siscu:entities/broth_cauldron/summon
