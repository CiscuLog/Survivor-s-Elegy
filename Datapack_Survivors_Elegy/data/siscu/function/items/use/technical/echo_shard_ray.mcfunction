...
execute if block ~ ~ ~ bell align xyz positioned ~0.5 ~0.5 ~0.5 as @e[type=!#siscu:glowing_invulnerable,tag=!invisible,distance=1..48] run function siscu:items/use/technical/vibration_to_entity
