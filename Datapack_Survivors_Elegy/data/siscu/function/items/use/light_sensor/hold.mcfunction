...
# offhand one
execute if predicate siscu:items/light_sensor_offhand run function siscu:items/use/light_sensor/display {Slot:"weapon.offhand",Slot_raw:"equipment.offhand"}
