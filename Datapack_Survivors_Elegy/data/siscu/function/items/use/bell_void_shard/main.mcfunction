...
effect give @e[type=!#siscu:glowing_invulnerable,distance=..48] glowing 5 0 true
...
execute anchored eyes run function siscu:items/use/bell_void_shard/echo_shard_ray
...
scoreboard players reset ray siscu.volatile
