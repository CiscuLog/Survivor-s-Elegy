...
execute if entity @s[tag=villager] run loot replace entity @e[tag=converted,limit=1,sort=nearest] armor.head loot siscu:entities/wither_skeleton/wither_skeleton_illager_skulls
...
execute if entity @s[tag=baby] as @e[tag=converted,limit=1,sort=nearest] run function siscu:entities/skeleton/summon_wither_baby
