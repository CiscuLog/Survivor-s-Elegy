...
execute as @e[type=marker,tag=siscu.broth_interacting] at @s run function siscu:entities/broth_cauldron/effects/add_food

# lower temperature, divides current temperature by 3
