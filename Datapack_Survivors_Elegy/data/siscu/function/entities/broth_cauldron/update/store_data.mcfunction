...
## potion data
execute if score broth_level siscu.broth_data matches 0 run data merge storage siscu:volatile {BrothCauldronData:{effects:[{probability:1,effect:{id:"minecraft:water",amplifier:0, duration:0}}]}}
execute store result storage siscu:volatile BrothCauldronData.effects[0].effect.duration int 1 run scoreboard players get potion_duration siscu.broth_data
