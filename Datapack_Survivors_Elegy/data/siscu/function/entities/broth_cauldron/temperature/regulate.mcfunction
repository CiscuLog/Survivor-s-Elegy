...
# effects
execute if entity @s[tag=siscu.broth_potion,tag=!siscu.broth_invisible] run function siscu:entities/broth_cauldron/effects/potion_particles
execute if score @s siscu.broth_temperature matches 1..99 run function siscu:entities/broth_cauldron/effects/broth_heating
execute if score @s siscu.broth_temperature matches 100.. run function siscu:entities/broth_cauldron/effects/broth_ready_particles
execute if score @s siscu.broth_temperature matches 100.. run function siscu:entities/broth_cauldron/effects/broth_ready_ambient

execute if score @s siscu.broth_temperature matches 100.. if entity @s[tag=!siscu.broth_ready] run function siscu:entities/broth_cauldron/effects/broth_ready
...
execute if block ~ ~ ~ cauldron run return run scoreboard players set @s siscu.broth_temperature 0
...
execute if score @s siscu.broth_temperature matches 150.. run return 0
...
# return if there's not enough food
execute if score food siscu.broth_data matches ..2 run return 0