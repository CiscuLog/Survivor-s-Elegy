...
execute as @e[tag=fire_spring_spawned] run data merge entity @s {item:{id:"minecraft:bone",Count:1b,components:{"custom_model_data":540001}},transformation:{scale:[1.01,1.01,1.01],translation:[0.0,-0.5,0.0]},start_interpolation:-1}
