data remove entity @s Offers.Recipes[{sell:{id:"minecraft:enchanted_book",components:{"minecraft:stored_enchantments":{"minecraft:mending":1}}}}]
...
data modify entity @s Offers.Recipes prepend value {buy:{id:"minecraft:emerald",count:1},sell:{id:"minecraft:book",count:1},maxUses:12,uses:0,priceMultiplier:0.05f,demand:0,rewardExp:true,xp:2}
