...
loot replace entity @s[tag=!siscu.new_zombified] weapon.mainhand loot siscu:entities/zombified_illager/witch_weapon
...
data merge entity @s {VillagerData:{profession:"cleric",type:"swamp"},Xp:1}
