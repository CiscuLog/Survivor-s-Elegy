...
## Entity Behav ##
execute if score @s[type=#siscu:rotting_mobs,tag=!stray_zombie,tag=!bogged_zombie] siscu.rotting_mob matches 100.. at @s run function siscu:entities/rotting_mobs/summon_skeleton
execute if score @s[tag=stray_zombie] siscu.rotting_mob matches 100.. at @s run function siscu:entities/rotting_mobs/summon_stray
execute if score @s[tag=bogged_zombie] siscu.rotting_mob matches 100.. at @s run function siscu:entities/rotting_mobs/summon_bogged
...
execute if score @s[type=wolf] siscu.rotting_mob matches 100.. at @s run function siscu:entities/rotting_mobs/summon_wolf
