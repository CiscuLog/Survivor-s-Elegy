summon bogged ~ ~ ~ {Tags:["bogged_checked","converted","rotten"]}
...
execute if entity @s[predicate=siscu:utils/is_baby] run item replace entity @e[tag=converted,limit=1,sort=nearest] armor.head with bone[custom_model_data=548207]
