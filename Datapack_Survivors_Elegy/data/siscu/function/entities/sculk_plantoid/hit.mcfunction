...
execute as @e[type=interaction,tag=siscu.sculk_plantoid] if data entity @s attack at @s as @e[type=marker,tag=siscu.sculk_plantoid,limit=1,sort=nearest] run function siscu:entities/sculk_plantoid/remove_xp
