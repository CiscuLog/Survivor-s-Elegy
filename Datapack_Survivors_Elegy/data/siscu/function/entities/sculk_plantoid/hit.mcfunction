...
execute as @e[type=interaction,tag=siscu.sculk_plantoid] if data entity @s attack at @s as @n[type=marker,tag=siscu.sculk_plantoid] run function siscu:entities/sculk_plantoid/remove_xp
