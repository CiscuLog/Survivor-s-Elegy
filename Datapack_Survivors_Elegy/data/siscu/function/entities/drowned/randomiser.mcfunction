...
# Run the randomiser
execute store success score x siscu.volatile run execute on vehicle if entity @s
execute unless score x siscu.volatile matches 0 run loot replace entity @s weapon loot siscu:entities/drowned/drowned_weapons
