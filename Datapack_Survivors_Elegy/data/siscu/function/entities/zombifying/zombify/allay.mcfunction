$summon vex ~ ~ ~ {Tags:["siscu.zombified","siscu.vex_checked"],ArmorItems:$(ArmorItems),HandItems:$(HandItems),ArmorDropChances:$(ArmorDropChances),HandDropChances:$(HandDropChances),Rotation:$(Rotation),FallDistance:$(FallDistance),\
\
Inventory:$(Inventory)\
\
}
...
playsound siscu_se:entity.allay.converted_to_zombified hostile @a ~ ~ ~
