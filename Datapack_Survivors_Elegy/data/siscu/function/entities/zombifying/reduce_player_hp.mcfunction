...
execute store result score @s siscu.entity_health run attribute @s minecraft:generic.max_health get
...
execute store result storage siscu:volatile x int 1 run scoreboard players get @s siscu.entity_health
...
execute if score @s siscu.entity_health matches 1.. run return run function siscu:entities/zombifying/reduce_player_hp_macro with storage siscu:volatile