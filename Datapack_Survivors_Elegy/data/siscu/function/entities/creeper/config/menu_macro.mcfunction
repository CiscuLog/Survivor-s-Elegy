...
data merge storage siscu:volatile {dialog:{dialog:'{"type": "multi_action",\
    "title": "Creeper Fuse Config",\
    "body": {\
        "type": "plain_message",\
        "contents": [\
            {\
            ...
            {\
                "text": "This panel is used to change the creeper fuse time and even add variation and impredactibility to its length.",\
                "bold": false\
            }\
        ]\
    },\
    "actions": [\
        {\
            ...
            "action": {\
                "type": "run_command",\
                "command": "/function siscu:entities/creeper/config/enable"\
            },\
            "tooltip": "Ah"\
        },\
        {\
            ...
            "action": {\
                "type": "run_command",\
                "command": "/function siscu:entities/creeper/config/disable"\
            },\
            "tooltip": "Ah"\
        }\
    ],\
