...
execute if block ^ ^ ^-0.5 suspicious_gravel run particle block{block_state:"gravel"} ^ ^ ^-0.5 0.25 0.25 0.25 0.3 32
execute if block ^ ^ ^-0.5 sand run setblock ^ ^ ^-0.5 suspicious_sand
execute if block ^ ^ ^-0.5 suspicious_sand run particle block{block_state:"sand"} ^ ^ ^-0.5 0.25 0.25 0.25 0.3 32
setblock ~ ~ ~ air
...
particle block{block_state:"oak_planks"} ~ ~ ~ 0 0 0 0.3 6
kill @s
