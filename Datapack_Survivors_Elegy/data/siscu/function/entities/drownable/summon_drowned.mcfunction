...
execute unless predicate siscu:utils/is_baby run summon drowned ~ ~ ~ {Tags:["siscu.drowned_checked","siscu.converted"]}
execute if predicate siscu:utils/is_baby run summon drowned ~ ~ ~ {Tags:["siscu.drowned_checked","siscu.converted"],IsBaby:true}
...
data modify entity @n[tag=siscu.converted] active_effects set from entity @s active_effects
...
playsound minecraft:entity.zombie.converted_to_drowned hostile @a ~ ~ ~
