...
execute unless predicate siscu:utils/is_baby run summon drowned ~ ~ ~ {Tags:["drowned_checked","converted"]}
execute if predicate siscu:utils/is_baby run summon drowned ~ ~ ~ {Tags:["drowned_checked","converted"],IsBaby:true}
...
data modify entity @e[tag=converted,limit=1,sort=nearest] active_effects set from entity @s active_effects
