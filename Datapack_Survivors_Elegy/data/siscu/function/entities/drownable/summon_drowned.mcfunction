...
execute unless predicate siscu:utils/is_baby run summon drowned ~ ~ ~ {Tags:["siscu.drowned_checked","converted"]}
execute if predicate siscu:utils/is_baby run summon drowned ~ ~ ~ {Tags:["siscu.drowned_checked","converted"],IsBaby:true}
...
data modify entity @n[tag=converted] active_effects set from entity @s active_effects
