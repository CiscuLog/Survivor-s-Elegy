...
execute if items entity @s armor.head * if predicate siscu:utils/50_percent run loot replace entity @s armor.head loot siscu:items/tools/top_hat
execute if items entity @s armor.head bundle run data merge entity @s {drop_chances:{head:1.0}}
