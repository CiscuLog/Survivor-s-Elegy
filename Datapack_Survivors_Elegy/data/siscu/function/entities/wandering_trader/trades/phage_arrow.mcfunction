...
execute as @n[tag=siscu.new_trade] at @s run loot replace entity @s weapon loot siscu:gameplay/trading/phage_arrow_price
execute as @n[tag=siscu.new_trade] at @s run loot replace entity @s armor.head loot siscu:items/combat/phage_arrow
