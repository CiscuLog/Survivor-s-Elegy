...
execute as @n[tag=siscu.new_trade] at @s run loot replace entity @s weapon loot siscu:gameplay/trading/totem_of_undying_price
execute as @n[tag=siscu.new_trade] at @s run item replace entity @s armor.head with minecraft:totem_of_undying
