...
execute as @n[tag=siscu.new_trade] at @s run loot replace entity @s weapon loot siscu:gameplay/trading/black_iron_axe_price
execute as @n[tag=siscu.new_trade] at @s run loot replace entity @s armor.head loot siscu:entities/wandering_trader/black_iron_axe
