...
execute as @e[tag=new_trade,limit=1,sort=nearest] at @s run item replace entity @s weapon with emerald 10
execute as @e[tag=new_trade,limit=1,sort=nearest] at @s run loot replace entity @s armor.head loot siscu:items/tools/allay_container_full_vex
