data modify entity @s[type=!wolf,type=!cat] leash.UUID set from entity @n[type=wandering_trader] UUID
execute if entity @s[type=#siscu:pets,type=!parrot] run data modify entity @s Owner set from entity @n[type=wandering_trader] UUID
