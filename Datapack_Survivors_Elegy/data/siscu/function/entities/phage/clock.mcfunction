...
execute if score @s[type=player,tag=siscu.zombie] siscu.zombifying >= zombie_timer_limit siscu.integer run return run function siscu:entities/phage/reduce_player_hp
