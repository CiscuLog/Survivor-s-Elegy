...
## Rotting ##
execute if score rotting siscu.integer matches 1 as @e[type=#siscu:rotting_mobs_any,tag=!smithed.entity] run function siscu:entities/rotting_mobs/main
...
execute as @e[type=#siscu:withering_convertible_variants,predicate=siscu:entities/is_skeleton_variant] if score @s siscu.withering matches 20.. at @s run return run function siscu:world/withering/conversion_generic with entity @s
